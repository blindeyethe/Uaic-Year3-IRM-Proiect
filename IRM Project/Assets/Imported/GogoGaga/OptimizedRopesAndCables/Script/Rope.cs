...
namespace GogoGaga.OptimizedRopesAndCables
{
    ...
    public class Rope : MonoBehaviour
    {
        ...
        public Vector3 bendDirection = Vector3.down;
        ...
        private Vector3 GetMidPoint()
        {
            ...
            var worldBendDir = bendDirection.normalized;
            
            if (bendReference != null)
                worldBendDir = bendReference.TransformDirection(worldBendDir);
            
            midpos += worldBendDir * (yFactor * bendStrength);
            return midpos;
        }
